...
{
 double temp_dmudpot = (A_star * pow(t, 2)) / (p * q * F);
...
{
 double temp_dmudp = (A_star * pot * pow(t, 2)) / (pow(p, 2) * q * F);
...
{
 double temp_dmudt_1 = (A_star * pot * pow(t, 2) * b) / (sqrt(F) * p * q);
 double temp_dmudt_2 = 2 * ((A_star * pot * t) / (p * q * F));
...
{
 double temp_dmudF_1 = (A_star * pot * pow(t, 3) * b) / (2 * p * q * (F * sqrt(F)));
 double temp_dmudF_2 = (A_star * pot * pow(t, 2)) / (p * q * pow(F, 2));
